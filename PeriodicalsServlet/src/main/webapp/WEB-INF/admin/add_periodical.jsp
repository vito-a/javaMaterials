...
<fmt:setBundle basename="messages"/>
    ...
    <div class="container text-center">
        <div>
            ...
            <form action="${pageContext.request.contextPath}/app/admin/add/periodical" method="post" style="max-width: 800px; margin: 0 auto;">
                <div class="m-3">

                    <div class="form-group row">
                        <label class="col-4 col-form-label" for="name"><fmt:message key="periodicals.name"/></label>
                        <div class="col-8">
                            <input id="name" class="form-control" name="name" type="text" th:pattern="${regexp.name}" th:field="*{name}" required>
                        </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-8">
                            <input id="description" class="form-control" name="description" type="description" th:field="*{description}" required>
                        </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-8">
                            <input id="category" class="form-control" name="category" type="text" th:pattern="${regexp.category}" th:field="*{category}" required>
                        </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-8">
                            <input id="price" class="form-control" name="price" type="text" th:pattern="${regexp.price}" th:field="*{price}" required>
                        </div>
