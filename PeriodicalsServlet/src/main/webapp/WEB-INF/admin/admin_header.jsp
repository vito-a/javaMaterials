...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    ...
    <div class="collapse navbar-collapse" id="navbarColor01">
        <ul class="navbar-nav mr-auto">
            <li class="nav-item"><a class="nav-link" href="/app/admin/users"><fmt:message key="pages.users" /></a></li>
            <li class="nav-item"><a class="nav-link" href="/app/admin/categories"><fmt:message key="pages.categories" /></a></li>
            <li class="nav-item"><a class="nav-link" href="/app/admin/periodicals"><fmt:message key="pages.periodicals" /></a></li>
            <li class="nav-item"><a class="nav-link" href="/app/admin/subscriptions"><fmt:message key="pages.subscriptions" /></a></li>
        </ul>
